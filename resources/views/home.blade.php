...
<body>
        <div class="container">
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <div class="row">
                <div class="col-md-6 separator social-login-box"> <h4>Login Mahasiswa</h4><br>
                    <a href="#" class="btn google btn-block" type="button"><li class="fab fa-google-plus-g "></li>Login With Google</a>
                        </div>
